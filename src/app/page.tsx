...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/man-filming-with-professional-camera_23-2149066314.jpg",
        ...
        {
          src: "http://img.b2bpic.net/free-photo/portrait-redhead-bearded-freelancer-photographer-holds-digital-camera-grey-background_613910-1558.jpg",
          alt: "Creative photographer",
        },
        {
          src: "http://img.b2bpic.net/free-photo/close-up-cameraman-doing-his-job_23-2149037887.jpg",
          alt: "Camera operator",
        },
        {
          src: "http://img.b2bpic.net/free-photo/young-woman-holding-cinema-tape-white-high-quality-photo_114579-63270.jpg",
      ...
      bulletPoints={[
        {
          ...
          description: "AI-powered storytelling hooks and deep chapter breakdowns.",
        },
        {
          title: "Visual Rendering",
          description: "Automated motion graphics and scene-by-scene animation.",
        },
        {
          title: "Cinematic Polish",
          description: "Netflix-quality voiceovers and sound design at your fingertips.",
        },
      ]}
      ...
      features={[
        {
          ...
          description: "5-10s automated scenes with visual instructions.",
        ...
        },
        {
          ...
          description: "Zoom, pan, and parallax transitions handled by AI.",
          imageSrc: "http://img.b2bpic.net/free-photo/artistic-blurry-colorful-wallpaper-background_58702-10373.jpg",
        },
        {
          title: "Human-Like Voice",
          description: "Deep, dramatic, and emotionally resonant narration.",
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          rating: 5,
          reviewCount: "2k",
          imageSrc: "http://img.b2bpic.net/free-photo/high-angle-music-making-studio_23-2149199978.jpg",
        },
        {
          id: "p3",
          brand: "Module",
        ...
        },
        {
          ...
          rating: 5,
          reviewCount: "5k",
          imageSrc: "http://img.b2bpic.net/free-photo/flat-lay-still-life-printer-toners-assortment_23-2149120689.jpg",
        },
        {
          id: "p5",
          brand: "Module",
        ...
        },
        {
          ...
          rating: 5,
          reviewCount: "3k",
          imageSrc: "http://img.b2bpic.net/free-photo/grunge-texture-dark-wallpaper-blackboard-chalkboard-room-wall_24972-2299.jpg",
        },
      ]}
  ...
  <div id="pricing" data-section="pricing">
      ...
      plans={[
        ...
        },
        {
          ...
          price: "$299",
          period: "/mo",
          description: "Designed for professional production studios.",
          button: {
            text: "Choose Pro",
          },
          featuresTitle: "Includes:",
      ...
      testimonials={[
        {
          id: "t1",
          name: "Sarah J.",
          imageSrc: "http://img.b2bpic.net/free-photo/traveler-photographer-studio-portrait-handsome-bearded_613910-1606.jpg",
        },
        {
          id: "t2",
          name: "Michael C.",
          imageSrc: "http://img.b2bpic.net/free-photo/smart-blonde-female-photographer-trendy-clothes-posing-while-leaning-professional-camera-with-tripod-studio-looks-camera-isolated-dark-background_613910-20980.jpg",
        },
        {
          id: "t3",
          name: "Emily R.",
        ...
        },
        {
          id: "t5",
          name: "Alex B.",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-confident-young-woman-holding-cup_23-2148452709.jpg",
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "Is the app for beginners?",
          content: "Absolutely! Our AI workflows help beginners achieve professional-grade results.",
        },
        {
          id: "q2",
          title: "Can I edit after rendering?",
          content: "Yes, we support exports to popular editing software like Premiere Pro.",
        },
        {
          id: "q3",
          title: "What tools are integrated?",
          content: "We integrate with ElevenLabs, Runway, and various motion graphic suites.",
        },
      ]}
